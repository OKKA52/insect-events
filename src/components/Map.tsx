...
export default function Map({ museums, resetKey, eventCounts, setVisibleMuseumIds }: MapProps) {
  ...
  return (
    ...
    >
      {setVisibleMuseumIds && (
        <BoundsSync museums={museums} onChangeVisibleMuseumIds={setVisibleMuseumIds} />
      )}
